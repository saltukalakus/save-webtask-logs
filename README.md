...
- Download the zip file and extract to a folder in your computer.
...
- Navigate to chrome://extensions/ and install the extension with <b>Load unpacked</b> by pointing the extracted folder.
